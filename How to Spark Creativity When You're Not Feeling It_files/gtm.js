...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return\"\/subscribe\"===",["escape",["macro",0],8,16],"?\"Coupon_tracking\":\"\/newsletter\"==",["escape",["macro",0],8,16],"?\"Newslettr_subscription\":\"Product_Like\"})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){if(\"\/subscribe\"===",["escape",["macro",0],8,16],")return\"\";if(\"\/newsletter\"===",["escape",["macro",0],8,16],"){var a=\"\";$(\".mat-checkbox-input\").each(function(){var b=jQuery(this).attr(\"aria-checked\");\"true\"==b\u0026\u0026(b=jQuery(this).attr(\"name\"),a=a+\"_\"+b)});return a}return jQuery(\".product-heading\").text()})();"]
    },{
      "function":"__v",
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",3],8,16],"*",["escape",["macro",4],8,16],"\/1E3,b=Math.floor(a\/60);a%=60;return b+\"m \"+a+\"s\"})();"]
    },{
      "function":"__v",
      ...
      "function":"__d",
      "vtp_elementSelector":".product-heading",
      "vtp_selectorType":"CSS"
    },{
      "function":"__d",
      "vtp_elementSelector":".banner-heading",
      "vtp_selectorType":"CSS"
    },{
      "function":"__u",
      "vtp_component":"QUERY",
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_load":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003E(function(){var a=document.createElement(\"script\");a.src=\"https:\/\/code.jquery.com\/jquery-3.3.1.min.js\";a.async=!0;a.addEventListener(\"load\",function(){window.google_tag_manager[",["escape",["macro",15],8,16],"].onHtmlSuccess(",["escape",["macro",16],8,16],")});a.addEventListener(\"error\",function(){window.google_tag_manager[",["escape",["macro",15],8,16],"].onHtmlFailure(",["escape",["macro",16],8,16],")});document.head.appendChild(a)})();\u003C\/script\u003E"],
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"Home_page_scroll",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",9],
      ...
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"Time on website",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",9],
      ...
      "vtp_elementSelector":".center-aligned-text",
      "vtp_firingFrequency":"MANY_PER_ELEMENT",
      "vtp_selectorType":"CSS",
      "vtp_onScreenRatio":"50",
      "vtp_uniqueTriggerId":"12685817_8",
      "tag_id":22
    },{
      "function":"__evl",
      "vtp_useOnScreenDuration":false,
      "vtp_useDomChangeListener":true,
      "vtp_elementSelector":".mat-simple-snackbar",
      "vtp_firingFrequency":"ONCE_PER_ELEMENT",
      "vtp_selectorType":"CSS",
      "vtp_onScreenRatio":"10",
      "vtp_uniqueTriggerId":"12685817_11",
      "tag_id":23
    },{
      "function":"__hl",
      "tag_id":24
      ...
      "vtp_uniqueTriggerId":"12685817_29",
      ...
      "vtp_interval":"30000",
      "vtp_limit":"120",
      "vtp_uniqueTriggerId":"12685817_34",
      "tag_id":28
    },{
      "function":"__html",
      "metadata":["map"],
      ...
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003EjQuery(document).on(\"click\",\"a.ham-menu-name\",function(){var a=jQuery(this).text();dataLayer.push({event:\"navigation\",eventCategory:\"Ham_Navigation\",eventAction:a,eventLabel:\"\"})});jQuery(document).on(\"click\",\".menu-exp-elem\",function(){var a=jQuery(this).text();console.log(a);var b=jQuery(this).closest(\".hamburger-menu-panel\").find(\"a.ham-menu-name\").text();console.log(b);dataLayer.push({event:\"navigation\",eventCategory:\"Ham_Navigation\",eventAction:b,eventLabel:a})});\njQuery(document).on(\"click\",\"a.nav-scroll-link\",function(){console.log(\"working\");var a=jQuery(this).text();dataLayer.push({event:\"navigation\",eventCategory:\"Navigation_bar\",eventAction:a,eventLabel:\"\"})});jQuery(document).on(\"click\",\".article-wrap-item\",function(){var a=jQuery(\".banner-heading\").text();console.log(\"Entered\");var b=jQuery(this).text();dataLayer.push({event:\"navigation\",eventCategory:\"Navigation_bar\",eventAction:a,eventLabel:b})});\u003C\/script\u003E  ",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":9
      ...
      "setup_tags":["list",["tag",0,0]],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003EjQuery(document).on(\"click\",\".sb-facebook\",function(){var a=jQuery(this).attr(\"sharebutton\"),b=jQuery(\".product-heading\").text();dataLayer.push({event:\"socialShare\",eventCategory:\"SocialShare\",eventAction:a,eventLabel:b})});jQuery(document).on(\"click\",\".sb-linkedin\",function(){var a=jQuery(this).attr(\"sharebutton\"),b=jQuery(\".product-heading\").text();dataLayer.push({event:\"socialShare\",eventCategory:\"SocialShare\",eventAction:a,eventLabel:b})});\njQuery(document).on(\"click\",\".whatsapp-icon-link\",function(){var a=jQuery(this).find(\"img\").attr(\"alt\"),b=jQuery(\".product-heading\").text();dataLayer.push({event:\"socialShare\",eventCategory:\"SocialShare\",eventAction:a,eventLabel:b})});\u003C\/script\u003E  ",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":10
      ...
      "setup_tags":["list",["tag",0,0]],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003EjQuery(document).on(\"click\",\".subscribe-intervention\",function(){dataLayer.push({event:\"subscription\",eventCategory:\"Subscription\",eventAction:\"Generic_subscription\",eventLabel:\"\"})});jQuery(document).on(\"click\",\".subscribe-btn\",function(){dataLayer.push({event:\"subscription\",eventCategory:\"Subscription\",eventAction:\"ContentPiecesDiv_subscription\",eventLabel:\"\"})});\u003C\/script\u003E  ",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":11
      ...
      "setup_tags":["list",["tag",0,0]],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003EjQuery(document).on(\"click\",\".ascend-brand\",function(){dataLayer.push({event:\"logoClick\",eventCategory:\"LogoClick\",eventAction:\"\",eventLabel:\"\"})});jQuery(document).on(\"click\",\".apply-coupon\",function(){dataLayer.push({event:\"couponApplyClick\",eventCategory:\"Coupon_apply_click\",eventAction:\"\",eventLabel:\"\"})});jQuery(document).on(\"click\",\".customizeFeed-intervention\",function(){dataLayer.push({event:\"CustomizeFeed_Click\",eventCategory:\"CustomizeFeed_Click\",eventAction:\"\",eventLabel:\"\"})});\njQuery(document).on(\"click\",\".newsletter-intervention\",function(){dataLayer.push({event:\"NewsLetter_Click\",eventCategory:\"SendMe_Newsletter\",eventAction:\"\",eventLabel:\"\"})});jQuery(document).on(\"click\",\".seacrh-icon\",function(){dataLayer.push({event:\"SearchIconClick\",eventCategory:\"SearchIconClick\",eventAction:jQuery(this).attr(\"alt\"),eventLabel:\"\"})});\njQuery(document).on(\"click\",\".ham-menu\",function(){dataLayer.push({event:\"MenuClick\",eventCategory:\"MenuClick\",eventAction:jQuery(this).attr(\"alt\"),eventLabel:\"\"})});jQuery(document).on(\"click\",\".horizontal-view-all\",function(){dataLayer.push({event:\"viewAll\",eventCategory:jQuery(this).text(),eventAction:jQuery(this).attr(\"href\"),eventLabel:\"\"})});\u003C\/script\u003E  ",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":18
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript data-gtmsrc=\"\/\/122d5ff8812f42f89b1586f156f9827c.js.ubembed.com\" async type=\"text\/gtmscript\"\u003E\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":19
  ...
  "predicates":[{
      ...
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"couponApplyClick"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"CustomizeFeed_Click"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"NewsLetter_Click"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"SearchIconClick"
    },{
      "function":"_eq",
      "arg0":["macro",7],
      "arg1":"MenuClick"
  ...
  "rules":[
    ...
    [["if",12],["add",3]],
    [["if",13],["add",3]],
    [["if",14,16],["unless",15],["add",4]],
    [["if",16],["unless",15,17],["add",5]],
    [["if",15,16,17],["add",6]],
    [["if",18,19],["add",7]],
    [["if",20],["add",8,9,10,11,12,13,16,17,18,19,20]],
    [["if",21],["add",14]],
    [["if",20,22],["add",15]]]
},
"runtime":[
...
function Fc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.M[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Hc={},Ic=null,Jc=Math.random();Hc.i="GTM-M7R5VM5";Hc.Ab="8l2";var Kc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0},Lc="www.googletagmanager.com/gtm.js";var Mc=Lc,Nc=null,Oc=null,Pc=null,Qc="//www.googletagmanager.com/a?id="+Hc.i+"&cv=7",Rc={},Sc={},Tc=function(){var a=Ic.sequence||0;Ic.sequence=a+1;return a};
...
Y.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(y){for(var z=[],B=y.split(","),A=0;A<B.length;A++){var E=Number(B[A]);if(isNaN(E))return[];n.test(B[A])||z.push(E)}return z}function c(){var y=0,z=0;return function(){var B=ei(),A=B.height;y=Math.max(v.scrollLeft+B.width,y);z=Math.max(v.scrollTop+A,z);return{Mf:y,Nf:z}}}function d(){q=M("self");
r=q.document;v=r.scrollingElement||r.body&&r.body.parentNode;x=c()}function e(y,z,B,A){var E=l(z),F={},I;for(I in E){F.ra=I;if(E.hasOwnProperty(F.ra)){var S=Number(F.ra);y<S||(wi({event:"gtm.scrollDepth","gtm.scrollThreshold":S,"gtm.scrollUnits":B.toLowerCase(),"gtm.scrollDirection":A,"gtm.triggers":E[F.ra].join(",")}),mg("sdl",z,function(T){return function(V){delete V[T.ra];return V}}(F),{}))}F={ra:F.ra}}}function g(){var y=x(),z=y.Mf,B=y.Nf,A=z/v.scrollWidth*100,E=B/v.scrollHeight*100;e(z,"horiz.pix",
p.yb,t.Bd);e(A,"horiz.pct",p.xb,t.Bd);e(B,"vert.pix",p.yb,t.Gd);e(E,"vert.pct",p.xb,t.Gd);lg("sdl","pending",!1)}function h(){var y=250,z=!1;r.scrollingElement&&r.documentElement&&q.addEventListener&&(y=50,z=!0);var B=0,A=!1,E=function(){A?B=pi(E,y):(B=0,g(),Di("sdl")&&!a()&&(Ra(q,"scroll",F),Ra(q,"resize",F),lg("sdl","init",!1)));A=!1},F=function(){z&&x();B?A=!0:(B=pi(E,y),lg("sdl","pending",!0))};return F}function k(y,z,B){if(z){var A=b(String(y));mg("sdl",B,function(E){for(var F=0;F<A.length;F++){var I=
String(A[F]);E.hasOwnProperty(I)||(E[I]=[]);E[I].push(z)}return E},{})}}function l(y){return ng("sdl",y,{})}function m(y){D(y.vtp_gtmOnSuccess);var z=y.vtp_uniqueTriggerId,B=y.vtp_horizontalThresholdsPixels,A=y.vtp_horizontalThresholdsPercent,E=y.vtp_verticalThresholdUnits,F=y.vtp_verticalThresholdsPixels,I=y.vtp_verticalThresholdsPercent;switch(y.vtp_horizontalThresholdUnits){case p.yb:k(B,z,"horiz.pix");break;case p.xb:k(A,z,"horiz.pct")}switch(E){case p.yb:k(F,z,"vert.pix");break;case p.xb:k(I,
z,"vert.pct")}Di("sdl")?ng("sdl","pending")||(w||(d(),w=!0),D(function(){return g()})):(d(),w=!0,v&&(Ei("sdl"),lg("sdl","pending",!0),D(function(){g();if(a()){var S=h();Qa(q,"scroll",S);Qa(q,"resize",S)}else lg("sdl","init",!1)})))}var n=/^\s*$/,p={xb:"PERCENT",yb:"PIXELS"},t={Gd:"vertical",Bd:"horizontal"},q,r,v,w=!1,x;(function(y){Y.__sdl=y;Y.__sdl.b="sdl";Y.__sdl.g=!0;Y.__sdl.priorityOverride=0})(function(y){y.vtp_triggerStartOption?m(y):Bf(function(){m(y)})})}();

Y.a.jsm=["customScripts"],function(){(function(a){Y.__jsm=a;Y.__jsm.b="jsm";Y.__jsm.g=!0;Y.__jsm.priorityOverride=0})(function(a){if(void 0!==a.vtp_javascript){var b=a.vtp_javascript;try{var c=M("google_tag_manager");return c&&c.e&&c.e(b)}catch(d){}}})}();Y.a.d=["google"],function(){(function(a){Y.__d=a;Y.__d.b="d";Y.__d.g=!0;Y.__d.priorityOverride=0})(function(a){var b=null,c=null,d=a.vtp_attributeName;if("CSS"==a.vtp_selectorType){var e=nf(a.vtp_elementSelector);e&&0<e.length&&(b=e[0])}else b=C.getElementById(a.vtp_elementId);b&&(c=d?Sa(b,d):Wa(b));return va(String(b&&c))})}();
